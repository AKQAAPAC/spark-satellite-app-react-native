...
4. (Optional) Add app icon and splash: place `icon.png`, `splash-icon.png`, and `adaptive-icon.png` in `assets/` (paths are set in `app.config.js`). Ionicons live in `assets/fonts/ionicons.ttf` (filled by postinstall).
